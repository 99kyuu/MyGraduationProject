...
import com.ldx.mygraduationproject.utils.ServiceUtils;
...
/**
 * Created by freeFreAme on 2019/1/2.
...
public class textActivity extends BaseActivity implements android.os.Handler.Callback {
    /**
     * 屏幕长度和宽度
     */
...
//        放到获取宽度之后
        ...
        if (StepCountCheckUtil.isSupportStepCountSensor(this)) {
            ...
            if(!ServiceUtils.isServiceRunning(this,"com.ldx.mygraduationproject.service.StepService")){
                Log.i("info", "服务未启动了！！");
            }
            else{
                Log.i("info", "服务已经启动了！！");
