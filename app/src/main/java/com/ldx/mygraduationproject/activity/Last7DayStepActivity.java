...
public class Last7DayStepActivity extends BaseActivity {
    ...
    protected void initData() {
        super.initData();
        getUser7DayPhysicalFromNet((String) SPUtlis.get(Last7DayStepActivity.this, AppConfig.AUTO_LOGIN_NAME, ""));
        getMinPhysicalFromNet((String) SPUtlis.get(Last7DayStepActivity.this, AppConfig.AUTO_LOGIN_NAME, ""));
        getMaxPhysicalFromNet((String) SPUtlis.get(Last7DayStepActivity.this, AppConfig.AUTO_LOGIN_NAME, ""));
