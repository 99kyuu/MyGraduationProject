...
public class RegularUtils {
    ...
    private RegularUtils() { throw new UnsupportedOperationException("cannot be instantiated"); }
    /** * 验证手机号（简单） */
    ...
    /** * 验证用户名,取值范围为a-z,A-Z,0-9,"_",汉字，不能以"_"结尾,用户名必须是4-10位 */
    private static final String REGEX_USERNAME = "^[\\w\\u4e00-\\u9fa5]{4,10}(?<!_)$";
    /** * 验证IP地址 */ private static final String REGEX_IP = "((2[0-4]\\d|25[0-5]|[01]?\\d\\d?)\\.){3}(2[0-4]\\d|25[0-5]|[01]?\\d\\d?)";
    //If u want more please visit http://toutiao.com/i6231678548520731137/
    /**
     *  @param string 待验证文本
     *  @return 是否符合手机号（简单）格式
     */
    public static boolean isMobileSimple(String string) { return isMatch(REGEX_MOBILE_SIMPLE, string); }
    /**
     * @param string 待验证文本
     * @return 是否符合手机号（精确）格式
     */
    public static boolean isMobileExact(String string) { return isMatch(REGEX_MOBILE_EXACT, string); }
    /**
     * @param string 待验证文本
     * @return 是否符合座机号码格式
     */
    ...
    /**
     * 验证密码，6-20位 字母大小写 符号 数字
     */
    private static final String PASSWORD = "^([A-Z]|[a-z]|[0-9]|[`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“'。，、？]){6,20}$";
