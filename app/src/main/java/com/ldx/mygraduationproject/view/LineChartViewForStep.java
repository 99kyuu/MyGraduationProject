package com.ldx.mygraduationproject.view;
...
import com.ldx.mygraduationproject.utils.DensityUtils;
...
public class LineChartViewForStep extends View {
    ...
    public LineChartViewForStep(Context context) {
        super(context);
        init();
    }

    public LineChartViewForStep(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public LineChartViewForStep(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void startAnim(LineChartViewForStep lineChartView, long duration) {
