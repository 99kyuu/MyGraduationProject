...
public class LineChartViewForWeight extends View {
    ...
    public LineChartViewForWeight(Context context) {
        super(context);
        init();
    }

    public LineChartViewForWeight(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public LineChartViewForWeight(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void startAnim(LineChartViewForWeight lineChartView, long duration) {
